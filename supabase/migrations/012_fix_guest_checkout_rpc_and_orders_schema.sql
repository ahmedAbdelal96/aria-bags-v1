-- ARIA guest checkout repair
-- Forward-only migration that aligns the guest checkout RPC with the simplified
-- handbag checkout shape and repairs live schema drift without dropping data.
