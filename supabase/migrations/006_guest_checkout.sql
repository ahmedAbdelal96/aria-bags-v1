-- ============================================
-- ARIA Guest Checkout Support
-- Adds guest-order fields and secure RPC helpers for anonymous checkout.
-- ============================================
...
ALTER TABLE public.orders
  ...
  ADD COLUMN IF NOT EXISTS confirmation_token UUID DEFAULT uuid_generate_v4() UNIQUE,
